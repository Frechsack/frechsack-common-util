...
class ArrayFactory {
    ...
    static class ArrayList<E> extends AbstractList<E> implements RandomAccess {
        ...
        ArrayList(frechsack.dev.util.array.Array<E> array) {
            this.array = array;
        }
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof frechsack.dev.util.array.Array)
                return equals(((frechsack.dev.util.array.Array<?>) o).asList());
    ...
    static class ArrayIterator<E> implements Iterator<E> {
        ...
        ArrayIterator(frechsack.dev.util.array.Array<E> array) {
            this.array = array;
        }
